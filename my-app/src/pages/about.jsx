        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <DevCard 
              ...
              color="#5161cf"
              github="https://github.com/sai-helloworld"   // 👈 Replace with actual URL
              linkedin="https://www.linkedin.com/in/sai-pavan-aa4067295/" // 👈 Replace with actual URL
            />
            {/* Developer 2 */}
            <DevCard 
              name="Gowri Jashwanth"
              ...
              color="#a855f7" 
              github="https://github.com/your-username"   // 👈 Replace with actual URL
            ...
            <DevCard 
              ...
              role="Data Analyst"
              image="https://api.dicebear.com/9.x/avataaars/svg?seed=Christopher"
              tags={['Python','Data Visualisation', 'SQL']}
              stats={[
                { label: 'Logic', val: 99 },
                { label: 'Models', val: 85 },
                { label: 'Social', val: 30 }
              ...
              color="#10b981" 
              github="https://github.com/gokul-106"   // 👈 Replace with actual URL
              linkedin="https://www.linkedin.com/in/gokul-krishna106/" // 👈 Replace with actual URL
            />
          </div>
        </div>
      </section>
...
// 🔹 Updated DevCard to accept and use github/linkedin props
const DevCard = ({ name, role, image, tags, stats, color, github, linkedin }) => (
  <div className="group relative bg-zinc-900/40 border border-white/10 rounded-2xl p-6 overflow-hidden hover:border-opacity-50 transition-all duration-500 hover:shadow-[0_0_30px_rgba(81,97,207,0.15)]">
    ...
    <div className="relative z-10">
      ...
      <div className="flex items-start justify-between mb-6">
        ...
        {/* 🔹 Social Icons updated with anchor tags */}
        <div className="flex gap-2 text-zinc-500">
          {github && (
